    ...
    <Wizard tree={tree} first="touristNumber">
        ...
        <div>
          ...
          <Controls>
            {({ destinations: { oneTourist, daysInBerlin } }) => (
              <div>
                <button onClick={oneTourist}>I am alone</button>
                <button onClick={daysInBerlin}>2 people</button>
      ...
      <Step name="oneTourist">
        <div>
          ...
          <br />
          <Controls>
            {({ destinations: { junior, daysInBerlin } }) => (
              <div>
      ...
      <Step name="conclusion">
        <div>TODO: add details of tickets that the user may buy.</div>
      </Step>
      <Step name="error">
        <div>
          I am error
